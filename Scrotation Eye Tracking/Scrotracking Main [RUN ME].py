...
def main():
    ...
    #TV Debug values
        ...
        protocol.eyeCalibTime = 0.5 #secs
        protocol.trainingTime = 0.5 #secs
    ...
    protocol.csvOutput([-1, (-1, -1), -1, -1, eyeStartTime, eyeStartTimeUTC])
...
main()
protocol.csvOutput([-1, (-1, -1), -1, -1, upTime(), UTCt()])